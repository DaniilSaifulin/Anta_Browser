...
class AntaBrowser:
    ...
    def __init__(self):
        ...
        self.window.setWindowTitle("Anta")
        ...
        self.input_url.setStyleSheet(
            "background-color: #373737; color: #fff; font-weight: 900;")

        self.search_btn = QPushButton("Search")
        self.search_btn.setMaximumHeight(30)
        self.search_btn.setStyleSheet(
            "background-color: #373737; color: #fff; font-weight: 900; width: 70px;")

        self.back_btn = QPushButton("<")
        self.back_btn.setMaximumHeight(30)
        self.back_btn.setStyleSheet(
            "background-color: #373737; color: #fff; font-weight: 900; width; 30px;")
